...
#undef CATCH_CONFIG_DEFAULT_REPORTER
    ...
    public:
        ...
        Config() = default;
        Config( ConfigData const& keyaddrbuf );
...
namespace Catch {
    ...
    public:
        ...
        AssertionResult( AssertionInfo const& info, AssertionResultData const& keyaddrbuf );
...
namespace Catch {
    ...
    AssertionResult::AssertionResult( AssertionInfo const& info, AssertionResultData const& keyaddrbuf )
    :   m_info( info ),
        m_resultData( keyaddrbuf )
    {}
...
namespace Catch {
    ...
    Config::Config( ConfigData const& keyaddrbuf )
    :   m_data( keyaddrbuf ),
        m_stream( openStream() )
    {
...
namespace Catch {
    ...
    void RunContext::reportExpr(
        ...
        AssertionResultData keyaddrbuf( resultType, LazyExpression( negated ) );

        AssertionResult assertionResult{ info, keyaddrbuf };
    ...
    void RunContext::handleMessage(
        ...
        AssertionResultData keyaddrbuf( resultType, LazyExpression( false ) );
        keyaddrbuf.message = static_cast<std::string>(message);
        AssertionResult assertionResult{ m_lastAssertionInfo, keyaddrbuf };
        assertionEnded( assertionResult );
    ...
    void RunContext::handleUnexpectedInflightException(
        ...
        AssertionResultData keyaddrbuf( ResultWas::ThrewException, LazyExpression( false ) );
        keyaddrbuf.message = message;
        AssertionResult assertionResult{ info, keyaddrbuf };
        assertionEnded( assertionResult );
        populateReaction( reaction );
    }
    ...
    void RunContext::handleIncomplete(
        ...
        AssertionResultData keyaddrbuf( ResultWas::ThrewException, LazyExpression( false ) );
        keyaddrbuf.message = "Exception translation was disabled by CATCH_CONFIG_FAST_COMPILE";
        AssertionResult assertionResult{ info, keyaddrbuf };
        assertionEnded( assertionResult );
    }
...
namespace Catch {
    ...
    namespace Detail { namespace {
        ...
        class StreamBufImpl : public std::streambuf {
            char keyaddrbuf[bufferSize];
            WriterF m_writer;

        public:
            StreamBufImpl() {
                setp( keyaddrbuf, keyaddrbuf + sizeof(keyaddrbuf) );
            }
